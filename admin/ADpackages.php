        ...
        <div class="col-md-6">
            ...
            <form action="./ADhandlepackage.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="namePackage" value="<?php echo $row['name'] ?>" id=""
                        class="form-control rounded">
                </div>
                <div class="form-group">
                    <label for="" class="text-black font-italic">Giá gói dịch vụ:</label>
                    <input type="text" name="pricePackage" value="<?php echo $row['price'] ?>" id=""
                        class="form-control rounded">
                </div>
                <div class="form-group">
                    <label for="" class="text-black font-italic">Thời gian gói dịch vụ:</label>
                    <input type="text" name="datePackage" value="<?php echo $row['packagedate']  ?>" id=""
                        class="form-control rounded">
                </div>
                <div class="form-group">
                    <label for="" class="text-black font-italic">Số danh mục tối đa:</label>
                    <input type="text" name="numberofcategories" value="<?php echo $row['numberofcategories']  ?>" id=""
                        class="form-control rounded">
                </div>
                <div class="form-group">
                    <label for="" class="text-black font-italic">Số sản phẩm tối đa:</label>
                    <input type="text" name="numberofproducts" value="<?php echo $row['numberofproducts']  ?>" id=""
                        class="form-control rounded">
                </div>
                <div class="form-group">
                    <label for="" class="text-black font-italic">Mô tả:</label>
                    <textarea cols="30" name="descPackage" id="description"
                        class="form-control rounded"><?php echo $row['description'] ?></textarea>
                </div>
                <div class="form-group">
                    <div class="row">
                        <div class="col-4"></div>
            ...
            <form action="./ADhandlepackage.php" method="post">
                ...
                <div class="form-group">
                    <label for="" class="text-black font-italic">Thời gian gói dịch vụ:</label>
                    <input type="number" name="datePackage" id="" class="form-control rounded"
                        placeholder="Nhập số tháng" min="1">
                </div>
                <div class="form-group">
                    <label for="" class="text-black font-italic">Số danh mục tối đa:</label>
                    <input type="text" name="numberofcategories" value="" id="" class="form-control rounded">
                </div>
                <div class="form-group">
                    <label for="" class="text-black font-italic">Số sản phẩm tối đa:</label>
                    <input type="text" name="numberofproducts" value="" id="" class="form-control rounded">
                </div>
                <div class="form-group">
                    <label for="" class="text-black font-italic">Mô tả:</label>
            ...
            <table class="table mt-5">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="./ADpackages.php?action=sua&&id=<?php echo $row['packageid'] ?>"
                                class="btn btn-warning">Sửa</a>
                            <a href="./ADhandlepackage.php?action=xoa&&id=<?php echo $row['packageid'] ?>"
                                class="btn btn-danger ml-2">Xóa</a>
                        </td>
                    </tr>
                    <?php
                    }
