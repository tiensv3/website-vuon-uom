                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="./BShandlecategory.php?action=thaydoitrangthai&&id=<?php echo $row['categoryid'] ?>" class="btn btn-primary">
                                    <?php
                                    if ($row['categorystatus'] == 1) {
                                        echo "Ẩn";
                                    } else {
                                ...
                                <a href="./BShandlecategory.php?action=xoa&id=<?php echo $row['categoryid'] ?>" class="btn btn-danger" onclick="return confirmDelete()">Xóa</a>
                            </td>
                        </tr>
                    <?php
                    }
